...
def query(tq, t, y, left=None, right=None):
  ...
  assert_valid_stepfun(t, y)
  # Query the step function to recover the interval value.
  (i0, i1), ((yq, _),) = math.sorted_lookup(tq, t, (y,), device_is_tpu())
...
def invert_cdf(u, t, w_logits):
  ...
  assert_valid_stepfun(t, w_logits)
  # Compute the PDF and CDF for each weight vector.
  w = jax.nn.softmax(w_logits, axis=-1)
  cw = integrate_weights(w)
  # Interpolate into the inverse CDF.
  t_new = math.sorted_interp(u, cw, t, device_is_tpu())
  return t_new
