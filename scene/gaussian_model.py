...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, use_neural_network: bool = False, max_opacity=0.99, tmin=0.2, max_primitives=800_000):
    ...
    @torch.no_grad
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, max_var=0, min_split_opacity=0.025, all_gaussians_num=0):
        min_denom = 1
        denom = self.denom
        ...
        if all_gaussians_num < self.max_primitives:
